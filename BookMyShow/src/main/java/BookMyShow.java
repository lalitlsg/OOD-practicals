...
public class BookMyShow {
    ...
    public static void main(String[] args) {
        ...
        Movie housefull = new Movie("HouseFull2", Language.HINDI, Genre.COMEDY);
        ...
        try {
            ...
            // Creating Show for Movie WALK TO REMEMBER avengers on 7 Jun 2020 @ 12:00 PM in BIG-CINEMA
            dateInString = "Friday, Jun 7, 2020 12:00:00 PM";
            date = formatter.parse(dateInString);
        ...
        ArrayList<Theatre> theatreArrayList = new ArrayList<>();
        theatreArrayList.add(pvr_gip);
        theatreArrayList.add(big_cinema);
        BookMyShow bookMyShow = new BookMyShow(theatreArrayList);

        // Searching Book My Show for all the shows of movie WALK TO REMEMBER
        ArrayList<Show> searchedShows = BookMyShow.searchShows("The Walk To Remember");
        ...
        */
        ...
        Show bookingShow = searchedShows.get(0);
        ...
        System.out.println("Ayush Ticket: " + ayush_ticket);
        System.out.println("Saurabh Ticket: " + saurabh_ticket);
        ...
        System.out.println("ayushNewTicket: " + ayushNewTicket);
        System.out.println("saurabhNewTicket: " + saurabhNewTicket);
